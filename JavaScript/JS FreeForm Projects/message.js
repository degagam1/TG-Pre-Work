...
/*function displayMessage() {
  ...
  console.log(MessageMixer.palindrome('apricot'));
  console.log(MessageMixer.pigLatin('This is a sentence', 'elephant'));
}*/
...
function displayMessage() {
  ...
  console.log(palindrome('apricot'));
  console.log(pigLatin('This is a sentence', 'elephant'));
}
